...
CREATE TABLE `instructors` (
  ...
  KEY `cisd_idx` (`course_id`),
  CONSTRAINT `cisd` FOREIGN KEY (`course_id`) REFERENCES `courses` (`course_id`),
  CONSTRAINT `useid` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`)
...
INSERT INTO `instructors` VALUES (331,107,1002),(333,108,1006);
