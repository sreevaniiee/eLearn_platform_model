...
CREATE TABLE `pending` (
  `pend_id` int NOT NULL AUTO_INCREMENT,
  `user_id` int DEFAULT NULL,
  `course_id` int DEFAULT NULL,
  PRIMARY KEY (`pend_id`),
  UNIQUE KEY `pend_id_UNIQUE` (`pend_id`),
  KEY `cidd_idx` (`course_id`),
  KEY `usid_idx` (`user_id`),
  CONSTRAINT `cidd` FOREIGN KEY (`course_id`) REFERENCES `courses` (`course_id`),
...
INSERT INTO `pending` VALUES (442,109,1001);
